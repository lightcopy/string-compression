...
class BurrowsWheelerSuite extends UnitTestSuite {
  private def roundtrip(s: String): Unit = {
    ...
    println(s"Roundtrip for string (${s.length} bytes)")
  ...
  test("encode benchmark") {
    ...
    bench("BurrowsWheelerRleEncoder", 1) {
      val out = new ByteArrayOutputStream()
  ...
  test("decode benchmark") {
    ...
    bench("BurrowsWheelerRleDecoder", 100) {
  ...
  private val input6 = """{"op": "Driver-op-cf6237ea21b2f84d", "target": "fetchPartialResult", "projectName": "driver", "tier": "new-tier-1", "buildHash": "ba251b2e95c9486bc8fe4c5873e3fef772813835", "someOtherCommit": "b24581f5137b32994594d54e3deae9f6f738761c", "sparkVersion": "2.2.0", "hostName": "1118-023520-hash-num-1_10_2_180_150", "apacheCommit": "99ce551a13f0918b440ddc094c3a32167d7ab3dd", "sqlFuncName": "head", "rootOpId": "SingletonRunTask-cf6237ea21b2f848", "executorName": "Partial Result", "status": "success", "branchName": "development", "type": "Driver", "parentOpId": "SingletonRunTask-df6237ea21b2f848"}"""
